...
def seed_users():
    ...
    funny = User(
        ...
        birthday='1997-02-18',
        bio='I steal tweets',
        profile_img='https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse1.mm.bing.net%2Fth%3Fid%3DOIP.N8RnY_B-3nvEITHjOMnpMQHaHa%26pid%3DApi&f=1',
        banner_img='https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse4.mm.bing.net%2Fth%3Fid%3DOIP.G93gkI8lfoySNItjcAkbBAHaCs%26pid%3DApi&f=1',
        password='password',
        created_at=datetime.datetime.now(),
        updated_at=datetime.datetime.now(),
        )
